"""
from https://github.com/QLYoo/AEMatter/blob/main/model.py
"""
...
import numpy as np
from networks.backbones import swin
import torch
...
class AEMatter(nn.Module):
    def __init__(self):
        ...
        # self.start_conv0 = nn.Sequential(nn.Conv2d(6, 48, 3, 1, 1), nn.PReLU(48)) # Original
        self.start_conv0 = nn.Sequential(nn.Conv2d(3, 48, 3, 1, 1), nn.PReLU(48)) # Hyebin
        ...
        self.convo = nn.Sequential(
            nn.Conv2d(in_channels=48 + 48 + 3, out_channels=32, kernel_size=3, stride=1, padding=1, bias=True),
